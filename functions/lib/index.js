...
exports.verifyRazorpayPayment = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const expectedSignature = razorpay_1.default.validateWebhookSignature(body, razorpay_signature, RAZORPAY_KEY_SECRET);
...
exports.razorpayWebhook = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        await admin.firestore().collection('auditLogs').add({
            ...
            details: `Payment ID: ${((_b = (_a = payload.payment) === null || _a === void 0 ? void 0 : _a.entity) === null || _b === void 0 ? void 0 : _b.id) || 'N/A'}`,
        });
    ...
    try {
        ...
        try {
            ...
            if (sellerDoc.exists) {
                ...
                await sendNewOrderNotificationToSeller(sellerData === null || sellerData === void 0 ? void 0 : sellerData.email, order.customerName, orderDoc.id);
            }
        }
        catch (emailError) {
 ...
 */
async function sendPaymentSuccessEmail(email, name, orderId, amount) {
    const mailOptions = {
        from: 'QuickXerox <noreply@quickxerox.com>',
        to: email,
 ...
 */
async function sendPaymentFailureEmail(email, name, orderId, reason) {
    const mailOptions = {
        from: 'QuickXerox <noreply@quickxerox.com>',
        to: email,
 ...
 */
async function sendNewOrderNotificationToSeller(email, customerName, orderId) {
    const mailOptions = {
        from: 'QuickXerox <noreply@quickxerox.com>',
        to: email,
