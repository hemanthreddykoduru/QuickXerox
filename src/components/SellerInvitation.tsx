...
const SellerInvitation = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: You need to set up EmailJS account and replace the credentials
      ...
      try {
        // EmailJS configuration with MailTrap SMTP
        await emailjs.send(
          'service_ogdlx38',      // MailTrap SMTP Service ID (updated)
          'template_0pb9q2y',     // Seller Invitation Template ID (updated)
          templateParams
        );
